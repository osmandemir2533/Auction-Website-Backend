        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dresses_AspNetUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Electronics_AspNetUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Estates_AspNetUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MusicalInstrumentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusicalInstruments", x => x.MusicalInstrumentId);
                    table.ForeignKey(
                        name: "FK_MusicalInstruments_AspNetUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentHistories_Dresses_DressId",
                        column: x => x.DressId,
                        principalTable: "Dresses",
                        principalColumn: "DressId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentHistories_Electronics_ElectronicId",
                        column: x => x.ElectronicId,
                        principalTable: "Electronics",
                        principalColumn: "ElectronicId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentHistories_Estates_EstateId",
                        column: x => x.EstateId,
                        principalTable: "Estates",
                        principalColumn: "EstateId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentHistories_MusicalInstruments_MusicalInstrumentId",
                        column: x => x.MusicalInstrumentId,
                        principalTable: "MusicalInstruments",
                        principalColumn: "MusicalInstrumentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bids_DressId",
                table: "Bids",
                column: "DressId");

            migrationBuilder.CreateIndex(
                name: "IX_Bids_ElectronicId",
                table: "Bids",
                column: "ElectronicId");

            migrationBuilder.CreateIndex(
                name: "IX_Bids_EstateId",
                table: "Bids",
                column: "EstateId");

            migrationBuilder.CreateIndex(
                name: "IX_Bids_MusicalInstrumentId",
                table: "Bids",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Estates_SellerId",
                table: "Estates",
                column: "SellerId");

            migrationBuilder.CreateIndex(
                name: "IX_MusicalInstruments_SellerId",
                table: "MusicalInstruments",
                column: "SellerId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentHistories_DressId",
                table: "PaymentHistories",
                column: "DressId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PaymentHistories_ElectronicId",
                table: "PaymentHistories",
                column: "ElectronicId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PaymentHistories_EstateId",
                table: "PaymentHistories",
                column: "EstateId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PaymentHistories_MusicalInstrumentId",
                table: "PaymentHistories",
                column: "MusicalInstrumentId",
                unique: true);
